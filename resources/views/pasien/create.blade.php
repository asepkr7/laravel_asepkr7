...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="m-0">Tambah Data Pasien</h4>
                </div>
                <div class="col-sm-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="rumah_sakit_id" id="rumah_sakit_id"
                                        class="form-control select2 select2-hidden-accessible @error('rumah_sakit_id') is-invalid @enderror">
                                        <option value="">-Pilih Rumah Sakit-</option>
                                        @foreach ($rumahSakits as $rumahSakit)
                                            @if (old('rumah_sakit_id') == $rumahSakit->id)
                                                <option value="{{ $rumahSakit->id }}" selected>{{ $rumahSakit->nama }}
                                                </option>
                                            @endif
