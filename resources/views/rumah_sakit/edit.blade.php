...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="m-0">Edit Data Rumah Sakit</h4>
                </div>
                <div class="col-sm-6">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h6 class="card-title">
                        ...
                        Form Edit Data Rumah Sakit
                    </h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('rumah-sakit.update', $rumah_sakit->id) }}" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                        value="{{ old('nama', $rumah_sakit->nama) }}" id="nama" name="nama"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        value="{{ old('email', $rumah_sakit->email) }}" id="email" name="email"
